    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-50">
      ...
      <nav className="md:hidden bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center justify-between">
          <h1 className="text-lg font-bold text-blue-600">Budget App</h1>
        </div>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden md:flex md:flex-col md:w-56 bg-white border-r border-gray-200 p-4 shrink-0">
        <h1 className="text-xl font-bold text-blue-600 mb-8 px-3">Budget App</h1>
